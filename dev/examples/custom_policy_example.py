...
class CustomPolicyExample:
    ...
    def setup_custom_policies(self):
        ...
        self.engine.update_constraints(
            {"max_cost_per_gb": 0.15, "min_copies": 2, "force_encryption": True}
        )
    ...
    def run_examples(self):
        ...
        for test_case in test_cases:
            ...
            decision = self.evaluate_data_placement(
                test_case["path"], test_case["pattern"]
            )
    ...
    def analyze_cost_impact(self):
        ...
        for data in test_data:
            ...
            logger.info(
                f"Current tier: {data['current_tier']}, cost: ${current_cost:.2f}"
            )
