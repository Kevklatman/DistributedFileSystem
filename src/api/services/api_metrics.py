...
LATENCY = Gauge(
    "storage_latency_milliseconds", "Storage operation latency in milliseconds"
)
    ...
    try:
        ...
        return {
            ...
            "active_policies": len(
                [
                    p
                    for p in policy_data.get("path_overrides", [])
...
def get_dashboard_metrics():
    ...
    try:
        ...
        return {
            ...
            "bandwidth": (BYTES_IN._value.get() + BYTES_OUT._value.get())
            / (1024 * 1024),  # MB/s
            "latency": latency,
