...
class StorageLocation:
    ...
    performance_tier: Literal[
        "premium_ssd", "standard_ssd", "standard_hdd", "archive"
    ] = "standard_ssd"
...
class StoragePool:
    ...
    dedup_state: "DeduplicationState" = field(
        default_factory=lambda: DeduplicationState()
    )
    compression_state: "CompressionState" = field(
        default_factory=lambda: CompressionState()
    )
    thin_provisioning_state: "ThinProvisioningState" = field(
        default_factory=lambda: ThinProvisioningState(allocated_size=0, used_size=0)
    )
