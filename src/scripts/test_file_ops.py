...
os.environ['STORAGE_ROOT'] = '/Users/kevinklatman/Development/Code/DistributedFileSystem/data/dfs'
...
def test_file_operations():
    ...
    if response.status_code == 200:
        ...
        for metric in metrics:
            if any(key in metric for key in ['file_operations', 'storage_usage', 'cache']):
                print(metric)
    else:
