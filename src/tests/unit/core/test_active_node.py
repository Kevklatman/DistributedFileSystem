...
class TestActiveNode:
    ...
    @pytest.mark.asyncio
    async def test_write_operation(self, active_node, mock_cluster_nodes, volume_dir, mock_get_node_metrics, mock_client_session):
    ...
    @pytest.mark.asyncio
    async def test_read_operation(self, active_node, mock_cluster_nodes, volume_dir, mock_get_node_metrics, mock_client_session):
    ...
    @pytest.mark.asyncio
    async def test_load_balancing(self, active_node, mock_cluster_nodes, mock_get_node_metrics):
    ...
    @pytest.mark.asyncio
    async def test_data_replication(self, active_node, mock_cluster_nodes, mock_get_node_metrics, mock_client_session):
