...
class PolicyScenarios:
    ...
    def setup_regulatory_compliance(self):
        ...
        self.engine.add_manual_override({
            ...
            "required_regions": ["us-east-1", "us-west-1"],  # HIPAA approved regions
    ...
    def setup_cost_optimization(self):
        ...
        self.engine.add_manual_override({
            ...
            "required_regions": ["us-east-1"],  # Single region for cost
    ...
    def setup_hybrid_cloud(self):
        ...
        self.engine.add_manual_override({
            "pattern": "**/public/**",
            "tier": "capacity",
            "required_regions": ["us-east-1", "us-west-1"],  # Cloud regions
